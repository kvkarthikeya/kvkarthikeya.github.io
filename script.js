...
College of Engineering</p><p class="duration">Research Project</p><p>Conducted research in computer vision and machine learning under faculty guidance.</p></div><div class="experience-card"><h3>Biomedical Engineering Researcher</h3><p class="company">Aarhus University</p><p class="duration">Research Collaboration</p><p>Collaborated on biomedical engineering projects applying AI to medical imaging.</p></div></div></section>`;
