...
const experiencePage = () => `<section class="section experience"><div class="container"><h2 class="section-title">Experience</h2><div class="experience-grid"><div class="experience-card"><h3>Software Engineer</h3><p class="company">AT&T</p><p class="duration">Full-time · 1.5 years</p><p>Developed and optimized data pipelines and model inference systems for enterprise AI/ML projects.</p></div><div class="experience-card"><h3>AI/ML Researcher</h3><p class="company">75
College of Engineering</p><p class="duration">Research Project</p><p>Conducted research in computer vision and machine learning under faculty guidance.</p></div><div class="experience-card"><h3>Biomedical Engineering Researcher</h3><p class="company"> University</p><p class="duration">Research Collaboration</p><p>Collaborated on biomedical engineering projects applying AI to medical imaging.</p></div></div></section>`;
